...
/////////////////
const BotName = 'ZERO BOT'; 
const instagram = 'https://instagram.com/zanganzz'; 
const telegram = 'https://t.me/SERARE GAMING'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Zan gaming';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@zanganzz_')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@zanganzz_`)
})
